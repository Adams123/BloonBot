...
infernal_hard = {
    ...
    "SUB_LOCATION_1": [1155,218],
    "SUB_LOCATION_2": [1231,185],
    "SUB_LOCATION_3": [469,879],
    "SUB_LOCATION_4": [1221,258],
    "ALCHEMIST_LOCATION": [838,755],
    "ACE_LOCATION": [1579,513],
    "VILLAGE_LOCATION": [1581,608],
    "BUCANEER_LOCATION": [499,792],
...
selected_map_config = {
    "INFERNAL_HARD": [infernal_hard, None, "OBYN"],
